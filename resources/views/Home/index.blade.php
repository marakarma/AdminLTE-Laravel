      ...
      <div class="row">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>UNIVERSITAS ISLAM BALITAR <span>BLITAR</span></h1>
            <h2>The Entreprenurial University</h2>
        ...
        {{-- @foreach ($artikel as $item)
          ...
          <div class="col-md-6" data-aos="zoom-out">
            <div class="post post-row">
              <a class="post-img" href="/artikel/{{$item->id}}/detail"><img src="{{ url('/') }}/assets/img/artikel/{{$item->gambar}}" alt=""></a>
              <div class="post-body">
                <div class="post-meta">
                  <a class="post-category cat-2" href="category.html">{{$item->kategori->nama}}</a>
                  <span class="post-date">{{$item->created_at}}</span>
                </div>
                <h3 class="post-title"><a href="/artikel/{{$item->id}}/detail">{{$item->judul}}</a></h3>
                <div >
                  <p>
